...
function Home({ onViewMenuClick }) {
  ...
  const handleOrderOnlineClick = () => {
    // Navigate to your dedicated order/menu page
    // Ensure you have a route like <Route path="/order" element={<OrderPage />} /> in your App.js
    navigate('/order'); 
  };
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between">
          <div className="w-full md:w-1/2 lg:w-2/5 text-center md:text-left mb-10 md:mb-0 pr-0 md:pr-8 lg:pr-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4">
              Delicious Flavors, <br className="hidden md:inline" />
              Delivered Fresh
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              <button
                ...
                onClick={handleOrderOnlineClick} // Attach the new click handler
              >
